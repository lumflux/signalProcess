...
class mainWin(QMainWindow):
    def __init__(self, call=None, parent=None):
        ...
        self.main_plot = mainPlot(self, 2, 3)
        
        self.signal_freq_axe = self.main_plot.get_axe(self.main_plot.get_grid()[0, 0])
        self.signal_freq_filt_axe = self.main_plot.get_axe(self.main_plot.get_grid()[1, 0])
        self.filter_freq_axe = self.main_plot.get_axe(self.main_plot.get_grid()[0, 1])
        self.filter_zpk_axe = self.main_plot.get_axe(self.main_plot.get_grid()[1, 1])
        self.heartbeat_time_axe = self.main_plot.get_axe(self.main_plot.get_grid()[0, 2])
        self.heartbeat_freq_axe = self.main_plot.get_axe(self.main_plot.get_grid()[1, 2])
